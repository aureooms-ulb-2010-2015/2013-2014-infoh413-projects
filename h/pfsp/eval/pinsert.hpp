#ifndef _PFSP_EVAL_PINSERT_HPP
#define _PFSP_EVAL_PINSERT_HPP
...
template<
	...
	typename A6
>
class pinsert : public functor<val_t, S, M, A6, A5>{
public:
	...
	virtual val_t operator()(const S& sol, const M& mutation, A6& detail, A5& wt){
		...
		val_t wtd = 0;
		for(addr_t j = l; j <= r; ++j) wtd -= wt_r[j];
